            ...
            <div class="main">
                ...
                <div class="operation-wrap">
                    <div class="buttons-wrap">
                        <button class="button blue radius-3" id="resume"><span class="icon-plus"></span>恢复</button>
                        <button class="button red radius-3" id="delete"><span class="icon-close2"></span>彻底删除</button>
                    </div>
                </div>
...
<script>
    ...
    $("#delete").click(function () {
        ...
        if (idArr.length==0){
            ...
            $.ajax({
                url : "${pageContext.request.contextPath}/article/delete.json",
                type: "POST",
                dataType: "json",
                traditional: "true",
                data:{
    ...
    $("#resume").click(function () {
        ...
        if (idArr.length==0){
            ...
            $.ajax({
                url : "${pageContext.request.contextPath}/article/resume.json",
                type: "POST",
                dataType: "json",
                traditional: "true",
                data:{
