            ...
            <div class="main">
                ...
                <table id="table" class="table color2">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${links}" var="entity" varStatus="status">
                                <tr>
                                    <td><input type="checkbox" name="id" class="fill listen-1-2" value="${entity.id}" /> </td>
                                    <td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入超链接地址" value="${entity.name}"></td>
                                    <td><input type="text" class="text" name="address" data-type="必填" placeholder="请输入超链接地址" value="${entity.address}"></td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
                    </c:choose>
...
<script>
    ...
    $("#add").click(function () {
        ...
        html += '<td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入超链接地址" value="${entity.name}"></td>';
        html += '<td><input type="text" class="text" name="address" data-type="必填" placeholder="请输入超链接地址" value="${entity.address}"></td>';
        html += '</tr>';
    ...
    $("#save").click(function () {
        ...
        $.ajax({
            url : "${pageContext.request.contextPath}/admin/saveLink.json",
            type: "POST",
            dataType: "json",
            traditional: "true",
            data:{
    ...
    $("#delete").click(function () {
        ...
        if (idArr.length==0){
            ...
            $.ajax({
                url : "${pageContext.request.contextPath}/admin/delete.json",
                type: "POST",
                dataType: "json",
                traditional: "true",
                data:{
