...
<div class="header">
    ...
    <h1 id="big-title">${pageInfo.list.get(0).name}博客</h1>
</div>
<div id="content">
                    ...
                    <div class="block block2">
                        <div class="grid-5-7" style="height: 250px;">
                            ...
                            <div class="main-15">
                                ...
                                <div class="day">更新时间：${entity.updateTime}</div>
                                <div class="day">浏览次数：${entity.viewCount}</div>
                            </div>
                        </div>
                    </div>
                </c:forEach>
...
<script>
    ...
    javaex.page({
        ...
        callback:function(rtn) {
            window.location.href="${pageContext.request.contextPath}/portal/type.action?pageNum="+rtn.pageNum+"&typeId="+${typeId}
        }
    });
</script>
</html>
