        ...
        <div class="block">
            ...
            <div class="main">
                ...
                <table id="table" class="table color2">
                    <thead>
                    <tr>
                        <th class="checkbox" style="width: 10px" class="checkbox"><input type="checkbox" class="fill listen-1" /> </th>
                        <th style=" width: 95%">留言内容</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${comments}" var="entity" varStatus="status">
                                <tr>
                                    <td><input type="checkbox" name="id" class="fill listen-1-2" value="${entity.id}"/> </td>
                                    <td><input type="text" class="text readonly" value="${entity.content}"/></td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
                    </c:choose>
...
<script>
    ...
    $("#delete").click(function () {
        ...
        if (idArr.length==0){
            ...
            $.ajax({
                url : "${pageContext.request.contextPath}/admin/deleteComment.json",
                type: "POST",
                dataType: "json",
                traditional: "true",
                data:{
