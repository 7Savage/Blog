                    ...
                    <div class="block block2">
                        <div class="grid-5-7" style="height: 250px;">
                            ...
                            <div class="main-15">
                                ...
                                <div class="day">浏览次数：${entity.viewCount}&nbsp; <%
                                    if (session.getAttribute("portalInfo")!=null){
                                        PortalInfo portalInfo= (PortalInfo) session.getAttribute("portalInfo");
                                %>
                                    <a href="${pageContext.request.contextPath}/portal/deleteStar.action?articleId=${entity.id}&portalId=<%=portalInfo.getId()%>">取消收藏</a>
                                    <%}%></div>
